...
#define FFMPEG_CONFIGURATION "--prefix=./buildout --disable-static --enable-shared --enable-gpl --enable-version3 --enable-decoder=h264 --enable-parser=h264 --arch=x86_64 --enable-sdl2 --disable-doc"
...
#define CC_IDENT "gcc 10.1.0 (Rev3, Built by MSYS2 project)"
