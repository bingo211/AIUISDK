...
void MD5_memcpy(void *output, void * input, unsigned int len);
void MD5_memset (void *output, int value, unsigned int len);
void MD5Init (MD5_CTX *context);
void MD5Update (MD5_CTX *context, unsigned char *input, unsigned int inputLen);
void MD5Final (unsigned char digest[16], MD5_CTX *context);

void get_md5_value(const char *string, unsigned int uStringLength, unsigned char *pstrReturnBuffer);
...
void get_md5_value(const char *string, unsigned int uStringLength, unsigned char *pstrReturnBuffer)
{
	assert(string && string[0] && uStringLength > 0 && pstrReturnBuffer);
